...
EMPLOYEE_PATH="/home/khaldi/Documents/master_mlsd/app_machine/seance1/datasets/whole data.csv"

bank=seance1(BANK_PATH,"y","yes")
credit=seance1(CREDIT_PATH,"Class",1,sep=",")
employee_attrition=seance1(EMPLOYEE_PATH,"Attrition","Yes",sep=",")